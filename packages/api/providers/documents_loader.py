...
from providers.document_conversion_service import (
    DocumentConversionError,
    DocumentConversionService,
)
from providers.liteparse_service import LiteParseError, LiteParseService
from core.ocr_language import presentation_language_to_ocr_code

# Optional fallback converter (primarily useful on Windows)
try:
    from providers.lightweight_document_service import DocumentService as DocumentServiceCls
except Exception:
