...
import providers.mem0_oss_memory as mem0_oss
from providers.mem0_presentation_memory_service import Mem0PresentationMemoryService
...
class TestMem0PresentationMemoryService:
    ...
    def test_shared_client_defaults_to_local_llm_without_openai_key(self):
        ...
        with patch.dict(
            ...
            {
                "MEM0_ENABLED": "true",
                "APP_DATA_DIRECTORY": "/tmp/DeckCraft-test",
