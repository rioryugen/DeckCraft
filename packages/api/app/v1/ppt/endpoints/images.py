...
from core.asset_directory_utils import (
    filesystem_image_path_to_app_data_url,
    get_images_directory,
    normalize_slide_asset_url,
)
from core.get_env import get_pexels_api_key_env, get_pixabay_api_key_env
from core.image_provider import get_selected_image_provider
from enums.image_provider import ImageProvider
import os
import uuid
from core.file_utils import get_file_name_with_random_uuid
...
async def search_stock_images(
    ...
    if normalized_provider == "pexels":
        ...
        if strict_api_key:
            validation_query = f"__DeckCraft_auth_check_{uuid.uuid4().hex}"
