...
from config.presentation import DEFAULT_TEMPLATES, MAX_NUMBER_OF_SLIDES
from enums.webhook_event import WebhookEvent
from schemas.api_error_model import APIErrorModel
from schemas.generate_presentation_request import GeneratePresentationRequest
from schemas.presentation_and_path import PresentationPathAndEditPath
from schemas.presentation_from_template import EditPresentationRequest
...
from schemas.presentation_with_slides import (
    PresentationWithSlides,
)
from schemas.sql.template import TemplateModel
from providers.documents_loader import DocumentsLoader
from providers.webhook_service import WebhookService
from providers.image_generation_service import ImageGenerationService
from providers.mem0_presentation_memory_service import (
    MEM0_PRESENTATION_MEMORY_SERVICE,
)
from core.dict_utils import deep_update
from core.export_utils import export_presentation
from core.llm_calls.generate_presentation_outlines import (
...
from schemas.sse_response import SSECompleteResponse, SSEErrorResponse, SSEResponse

from providers.database import get_async_session
from providers.concurrent_service import CONCURRENT_SERVICE
...
from core.asset_directory_utils import get_images_directory
from core.llm_calls.generate_presentation_structure import (
    generate_presentation_structure,
)
from core.llm_calls.generate_slide_content import (
    get_slide_content_from_type_and_outline,
)
from core.ppt_utils import (
    select_toc_or_list_slide_layout_index,
)
from core.outline_utils import (
...
from core.process_slides import (
    process_slide_add_placeholder_assets,
    process_slide_and_fetch_assets,
)
from core.get_layout_by_name import get_layout_by_name
from core.llm_utils import message_content_to_text
from core.simple_auth import (
    SESSION_COOKIE_NAME,
    create_session_token,
    get_session_token_from_request,
)
from schemas.presentation_layout import PresentationLayoutModel
import uuid
