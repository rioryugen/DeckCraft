...
from core.oauth.pkce import generate_pkce
...
# Simple branded success page for DeckCraft authentication
SUCCESS_HTML = """<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>DeckCraft – Authentication successful</title>
  <style>
    :root {
...
<body>
  <main class="card">
    ...
    <p>You can now return to DeckCraft to continue.</p>
...
<head>
  <meta charset="utf-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <title>DeckCraft – Authentication issue</title>
  <style>
...
<body>
  <main class="card">
    ...
    <p>We’ll gently reload this page. If the issue persists, close this window and restart sign-in from DeckCraft.</p>
