...
from config.documents import PPTX_MIME_TYPES
...
from core.get_env import get_app_data_directory_env
from core.asset_directory_utils import absolute_fastapi_asset_url
...
def _app_data_directory() -> str:
    app_data_dir = get_app_data_directory_env() or "/tmp/DeckCraft"
