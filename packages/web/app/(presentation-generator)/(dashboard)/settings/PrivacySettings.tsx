...
import { setTelemetryEnabled } from "@/lib/mixpanel";
    ...
    <div className="w-full space-y-6">
      <div className="bg-[#F9F8F8] p-7 rounded-[20px]">
        ...
        <p className="text-xs text-[#6B7280] mb-6 leading-relaxed max-w-lg">
          Share anonymous usage data to help us improve DeckCraft. No personal information or presentation content is collected.
        </p>
