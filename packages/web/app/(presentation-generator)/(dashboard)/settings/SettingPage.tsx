...
const SettingsPage = () => {
  ...
  const [mode, setMode] = useState<'nanobanana' | 'DeckCraft'>('DeckCraft')
    ...
    <div className="h-screen font-syne flex flex-col overflow-hidden relative">
      ...
      <main className="w-full mx-auto gap-6   overflow-hidden flex ">
        ...
        <div className="w-full">
          ...
          {mode === 'DeckCraft' && selectedProvider === 'text-provider' && <TextProvider
            ...
            llmConfig={llmConfig}
          />}
          {mode === 'DeckCraft' && selectedProvider === 'image-provider' && <ImageProvider llmConfig={llmConfig} setLlmConfig={setLlmConfig} />}
