        ...
        >
            <div>
                ...
                <Link href={`/dashboard`} className="flex items-center  pb-6 border-b border-[#E1E1E5]   gap-2    ">
                    <div className="bg-[#7C51F8] rounded-full cursor-pointer p-1 flex justify-center items-center mx-auto">
                        <img src="/logo-with-bg.png" alt="DeckCraft logo" className="h-[40px] object-contain w-full" />
                    </div>
                </Link>
            ...
            >
                <div className="mb-4">
                    ...
                    <Link href="https://docs.DeckCraft.ai/help" target="_blank" className="flex flex-col tex-center items-center gap-2  transition-colors"><HelpCircle className="w-4 h-4" /><span className="text-[11px] text-slate-800">Help</span></Link>
                </div>
                <div className="mb-4">
