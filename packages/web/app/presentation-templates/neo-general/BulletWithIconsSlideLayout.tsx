...
const bulletWithIconsSlideSchema = z.object({
    ...
    bulletPoints: z.array(z.object({
    ...
    })).min(1).max(3).default([
        {
            ...
            icon: {
                __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.svg',
