    ...
    .default([
      {
        ...
        icon: {
          __icon_url__:
            "https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg",
      ...
      },
      {
        ...
        icon: {
          __icon_url__:
            "https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/fediverse-logo-bold.svg",
      ...
      },
      {
        ...
        icon: {
          __icon_url__:
            "https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/video-bold.svg",
          __icon_query__: "warning alert inefficiency",
        },
      },
      {
        ...
        icon: {
          __icon_url__:
            "https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/users-four-bold.svg",
          __icon_query__: "warning alert inefficiency",
        },
      },
    ])
