...
const SummaryCardSchema = z.object({
  ...
  icon: z.object({
    __icon_url__: z.string().default("https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/placeholder.svg"),
    __icon_query__: z.string().default("pulse icon"),
  }).optional().meta({
    description: "Icon shown in each compact summary card.",
  }).default({
    __icon_url__: "https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/placeholder.svg",
