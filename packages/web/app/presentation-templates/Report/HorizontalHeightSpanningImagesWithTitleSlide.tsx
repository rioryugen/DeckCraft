...
const MemberSchema = z.object({
  ...
  image: z.object({
    __image_url__: z.string().default("https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/images/placeholder.jpg"),
    __image_prompt__: z.string().default("Professional portrait of a team member"),
  }).default({
    __image_url__: "https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/images/placeholder.jpg",
