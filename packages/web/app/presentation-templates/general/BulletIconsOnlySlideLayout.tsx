...
const bulletIconsOnlySlideSchema = z.object({
    ...
    bulletPoints: z.array(z.object({
    ...
    })).min(2).max(3).default([
        {
            ...
            icon: {
                __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/code-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/users-four-bold.svg',
        ...
        },
        {
            ...
            icon: {
                __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/headphones-bold.svg',
