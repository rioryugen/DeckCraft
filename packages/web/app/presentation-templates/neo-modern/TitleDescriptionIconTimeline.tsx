...
export const Schema = z.object({
    ...
    processItems: z.array(z.object({
        ...
        {
            icon: { __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'growth chart' },
            heading: '2021',
            subDescription: 'Briefly elaborate on what you want to discuss.Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'money bag' },
            heading: '2020',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'global' },
            heading: '2019',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'handshake' },
            heading: '2018',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        },
        {
            icon: { __icon_url__: 'https://DeckCraft-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'lightbulb' },
            heading: '2017',
            subDescription: 'Briefly elaborate on what you want to discuss.'
        }
    ])
