...
import { DALLE_3_QUALITY_OPTIONS, GPT_IMAGE_1_5_QUALITY_OPTIONS, IMAGE_PROVIDERS, LLM_PROVIDERS } from '@/lib/providerConstants';
...
import { getLLMConfigValidationError, handleSaveLLMConfig } from '@/lib/storeHelpers';
import { checkIfSelectedOllamaModelIsPulled, pullOllamaModel } from '@/lib/providerUtils';
import { getApiUrl } from '@/lib/api';
import CodexConfig, { CHATGPT_MODELS } from '../CodexConfig';
import VertexAzureManualFields from '@/shared/VertexAzureManualFields';
import OpenAICompatibleImageFields from '@/shared/OpenAICompatibleImageFields';

const MANUAL_MODEL_PROVIDERS = new Set(["vertex", "azure"]);

const DeckCraftMode = ({ currentStep, setStep }: { currentStep: number, setStep: (step: number) => void }) => {
    ...
    return (
        <div className='w-full max-w-[660px] font-syne pb-10'>
            <p className='px-2.5 py-0.5 w-fit text-[#7A5AF8] rounded-[50px]  border border-[#EDEEEF] text-[10px] font-medium mb-5 font-syne'>DeckCraft</p>
            <div className=''>
