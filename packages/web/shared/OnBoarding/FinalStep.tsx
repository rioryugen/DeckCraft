...
import { trackEvent, MixpanelEvent, setTelemetryEnabled } from "@/lib/mixpanel";
    ...
    return (
        <div className='fixed top-0 left-0 w-full h-full flex flex-col items-center justify-center'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <img src="/final_onboarding.png" alt="DeckCraft" className='w-[118px] h-[98px]  object-contain' />
                ...
                {trackingEnabled !== null && (
                    <div className='flex items-center gap-3 mt-8 px-5 py-3.5 rounded-[10px] border border-[#EDEEEF] bg-white'>
                        <div>
                            ...
                            <p className='text-[11px] text-[#9CA3AF] font-syne leading-tight mt-0.5'>Help improve DeckCraft by sharing anonymous usage data.</p>
                        </div>
                        <Switch
