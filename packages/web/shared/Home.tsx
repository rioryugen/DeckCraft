...
import { handleSaveLLMConfig } from "@/lib/storeHelpers";
import {
  checkIfSelectedOllamaModelIsPulled,
  pullOllamaModel,
} from "@/lib/providerUtils";
import { LLMConfig } from "@/types/llm_config";
import { trackEvent, MixpanelEvent } from "@/lib/mixpanel";
...
import DeckCraftMode from "./OnBoarding/DeckCraftMode";
...
export default function Home() {
  ...
  const [selectedMode, setSelectedMode] = useState<string>("DeckCraft")
  ...
  return (
    ...
    <div className="flex min-h-screen relative">
      ...
      <main className="w-full pl-20 pr-8 max-w-[1440px] mx-auto relative z-10">
        ...
        {step === 2 && selectedMode === "DeckCraft" && <DeckCraftMode currentStep={step} setStep={setStep} />}
