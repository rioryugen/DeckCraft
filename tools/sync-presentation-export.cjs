/**
 * Download DeckCraft-export release (Linux x64) into repo-root `presentation-export/`.
...
const exportRepoBase =
  "https://github.com/DeckCraft/DeckCraft-export/releases/download";
...
function requestJson(url, redirects = 5) {
  return new Promise((resolve, reject) => {
    ...
    const req = client.get(
      ...
      {
        headers: {
          "User-Agent": "DeckCraft-presentation-export-sync",
...
async function resolveLatestTag() {
  const apiUrl =
    "https://api.github.com/repos/DeckCraft/DeckCraft-export/releases/latest";
