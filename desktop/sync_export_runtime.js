...
const exportRepoBase = "https://github.com/DeckCraft/DeckCraft-export/releases/download";
...
async function getTargetVersion() {
  ...
  const apiUrl = "https://api.github.com/repos/DeckCraft/DeckCraft-export/releases/latest";
...
function requestJson(url, redirects = 5) {
  return new Promise((resolve, reject) => {
    ...
    const req = client.get(
      ...
      {
        headers: {
          "User-Agent": "DeckCraft-export-runtime-sync",
